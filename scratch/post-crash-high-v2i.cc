...
private:
  ...
  //\{
  NodeContainer nodes;
  NodeContainer rsu_nodes; // SOS RSU = node 1 ** Gantry RSU = node 0
              ...
              if (ttl > 1 && src == "10.0.0.1" && Simulator::Now ().GetSeconds () >= 96)
                {
                  ...
                  NS_LOG_UNCOND("AAAAAAAAAAAAAAAAAAA " << packetsSent[nodeid]);
...
//  Config::SetDefault ("ns3::WifiRemoteStationManager::RtsCtsThreshold", UintegerValue (1)); // enable rts cts all the time.
  ...
  coursechangelog = "/home/cnm/jjardim/gpsr/ns3-gpsr/mylogs/accident_tests_24082012/logs/" + comm_mode + "/" + traffic_density + "/" + test_id + "/course_changes_" + runID_str + ".log";

  finalcoursechangelog = "/home/cnm/jjardim/gpsr/ns3-gpsr/mylogs/accident_tests_24082012/logs/" + comm_mode + "/" + traffic_density + "/" + test_id + "/final_course_changes_" + runID_str + ".log";

  txlogFile = "/home/cnm/jjardim/gpsr/ns3-gpsr/mylogs/accident_tests_24082012/logs/" + comm_mode + "/" + traffic_density + "/" + test_id + "/tx_packets_" + runID_str + ".log";

  rxlogFile = "/home/cnm/jjardim/gpsr/ns3-gpsr/mylogs/accident_tests_24082012/logs/" + comm_mode + "/" + traffic_density + "/" + test_id + "/rx_packets_" + runID_str + ".log";
  ...
  tx_rx_per_node = "/home/cnm/jjardim/gpsr/ns3-gpsr/mylogs/accident_tests_24082012/logs/" + comm_mode + "/" + traffic_density + "/" + test_id + "/pdr_info_" + runID_str + ".log";
...
GpsrExample::InstallApplications ()
{
  ...
  app.Start (Seconds (96.0)); // Accident time
  app.Stop (Seconds (totalTime - 0.1));
